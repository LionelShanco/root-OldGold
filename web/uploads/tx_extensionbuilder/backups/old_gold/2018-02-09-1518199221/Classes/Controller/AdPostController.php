...
class AdPostController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    protected function setTypeConverterConfigurationForImageUpload($argumentName)
    {
        ...
        $newExampleConfiguration->forProperty('image')->setTypeConverterOptions('OldGold\\OldGold\\Property\\TypeConverter\\UploadedFileReferenceConverter', $uploadConfiguration);
        $newExampleConfiguration->forProperty('imageCollection.0')->setTypeConverterOptions('OldGold\\OldGold\\Property\\TypeConverter\\UploadedFileReferenceConverter', $uploadConfiguration);
    }
}
